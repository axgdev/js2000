// Example: Show contents of /mnt/sda1/log.txt using drawText8x8
var logText = FS.readFile('/mnt/sda1/log.txt');
if (logText === null) {
    drawText8x8(8, 16, 'Could not open /mnt/sda1/log.txt', 0xFFFF0000);
} else {
    ...
    for (var i = 0; i < lines.length; ++i) {
        drawText8x8(8, y, lines[i], 0xFFFFFFFF);
